...
//	@Inject private UtenteDad utenteDad;
	...
	private Utente initMarkerIrideDev() {
		final String methodName = "initMarkerIrideDev";
		Identita identita;
		try {
			
			//it.csi.comonl.comonlweb.

			//AdapterIride.getInstance().getListRuoliIride(identitaIride);
