 ...
 * The Class FzErrori.
 */
public class FzErrori extends BaseDto<Long> implements Serializable {
	...
	/**
	 * @return the cfAziendaCfLavoratore
	 */
	public String getCfAziendaCfLavoratore() {
		return cfAziendaCfLavoratore;
	}
	
	/**
	 * @param cfAziendaCfLavoratore the cfAziendaCfLavoratore to set
	 */
