...
import it.csi.comonl.comonlweb.lib.external.impl.silp.model.Decodifica;
...
public class Referente   {
  ...
  private String dsQuestura = null;
  ...
  private List<Decodifica> ruoli = new ArrayList<Decodifica>();
  ...
  @JsonProperty("dsMotivoTitoloSoggiorno")
  public String getDsMotivoTitoloSoggiorno() {
    return dsMotivoTitoloSoggiorno;
  }
  public void setDsMotivoTitoloSoggiorno(String dsMotivoTitoloSoggiorno) {
    this.dsMotivoTitoloSoggiorno = dsMotivoTitoloSoggiorno;
  }
  ...
  @JsonProperty("dsTitoloSoggiorno")
  public String getDsTitoloSoggiorno() {
    return dsTitoloSoggiorno;
  }
  public void setDsTitoloSoggiorno(String dsTitoloSoggiorno) {
    this.dsTitoloSoggiorno = dsTitoloSoggiorno;
  }
  ...
  @JsonProperty("ruoli")
  public List<Decodifica> getRuoli() {
    return ruoli;
  }
  public void setRuoli(List<Decodifica> ruoli) {
    this.ruoli = ruoli;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(cap, referente.cap) &&
        Objects.equals(denominazione, referente.denominazione) &&
        Objects.equals(dsCognome, referente.dsCognome) &&
        Objects.equals(dsMotivoTitoloSoggiorno, referente.dsMotivoTitoloSoggiorno) &&
        Objects.equals(dsNome, referente.dsNome) &&
        Objects.equals(dsQuestura, referente.dsQuestura) &&
        Objects.equals(dsTitoloSoggiorno, referente.dsTitoloSoggiorno) &&
        Objects.equals(dtNascita, referente.dtNascita) &&
        Objects.equals(dtRichiestaTitoloSoggiorno, referente.dtRichiestaTitoloSoggiorno) &&
        Objects.equals(dtScadenzaTitoloSoggiorno, referente.dtScadenzaTitoloSoggiorno) &&
        Objects.equals(fax, referente.fax) &&
        Objects.equals(faxAzienda, referente.faxAzienda) &&
        Objects.equals(genere, referente.genere) &&
        Objects.equals(id, referente.id) &&
        Objects.equals(codMinCittadinanza, referente.codMinCittadinanza) &&
        Objects.equals(idComune, referente.idComune) &&
        Objects.equals(idComuneNasc, referente.idComuneNasc) &&
        Objects.equals(codMinMotivoTitoloSoggiorno, referente.codMinMotivoTitoloSoggiorno) &&
        Objects.equals(idNazione, referente.idNazione) &&
        Objects.equals(idNazioneNasc, referente.idNazioneNasc) &&
        Objects.equals(codMinQuestura, referente.codMinQuestura) &&
        Objects.equals(idSede, referente.idSede) &&
        Objects.equals(codMinTitoloSoggiorno, referente.codMinTitoloSoggiorno) &&
        Objects.equals(indirizzo, referente.indirizzo) &&
        Objects.equals(mail, referente.mail) &&
        Objects.equals(numCivico, referente.numCivico) &&
        Objects.equals(note, referente.note) &&
        Objects.equals(numeroTitoloSoggiorno, referente.numeroTitoloSoggiorno) &&
        Objects.equals(ruoli, referente.ruoli) &&
        Objects.equals(sitoWeb, referente.sitoWeb) &&
        Objects.equals(telefono, referente.telefono) &&
        Objects.equals(telefonoAzienda, referente.telefonoAzienda) &&
        Objects.equals(toponimo, referente.toponimo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cap, denominazione, dsCognome, dsMotivoTitoloSoggiorno, dsNome, dsQuestura, dsTitoloSoggiorno, dtNascita, dtRichiestaTitoloSoggiorno, dtScadenzaTitoloSoggiorno, fax, faxAzienda, genere, id, codMinCittadinanza, idComune, idComuneNasc, codMinMotivoTitoloSoggiorno, idNazione, idNazioneNasc, codMinQuestura, idSede, codMinTitoloSoggiorno, indirizzo, mail, numCivico, note, numeroTitoloSoggiorno, ruoli, sitoWeb, telefono, telefonoAzienda, toponimo);
  }
  ...
  public String toString() {
    ...
    sb.append("    dsMotivoTitoloSoggiorno: ").append(toIndentedString(dsMotivoTitoloSoggiorno)).append("\n");
    sb.append("    dsNome: ").append(toIndentedString(dsNome)).append("\n");
    sb.append("    dsQuestura: ").append(toIndentedString(dsQuestura)).append("\n");
    sb.append("    dsTitoloSoggiorno: ").append(toIndentedString(dsTitoloSoggiorno)).append("\n");
