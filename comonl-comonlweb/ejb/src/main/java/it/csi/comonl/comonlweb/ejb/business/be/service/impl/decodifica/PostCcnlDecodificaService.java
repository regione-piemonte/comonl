 ...
 * Gets the Provincias
 */
public class PostCcnlDecodificaService extends BaseDecodificaService<PostCcnlDecodificaRequest, PostDecodificaGenericaResponse> {
	 ...
	 */
	public PostCcnlDecodificaService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
	...
	protected void execute() {
		...
		List<DecodificaGenerica> res = decodificaDad.getCcnlDecodifica(request.getFiltro());
		if(res == null || res.size() <= 0) {
			apiErrors.add(MsgComonl.COMCOMW098.getError());
		}
