 ...
 */
public class PutSoggettoAbilitatoResponse extends BaseGetResponse<SoggettoAbilitato> {
	...
	public String toString() {
		...
		builder.append(this.getClass().getSimpleName() + " [PutSoggettoAbilitatoResponse=").append(soggettoAbilitato).append(", apiErrors=")
