 ...
 * Gets the Categorias
 */
public class GetQuesturaService extends BaseDecodificaService<GetQuesturaRequest, GetQuesturaResponse> {
	 ...
	 */
	public GetQuesturaService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		response.setQuesturas(decodificaDad.getQuestura());
	}
