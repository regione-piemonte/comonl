 ...
 * Gets the Categorias
 */
public class GetNaturaGiuridicaService extends BaseDecodificaService<GetNaturaGiuridicaRequest, GetNaturaGiuridicaResponse> {
	 ...
	 */
	public GetNaturaGiuridicaService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		response.setNaturaGiuridicas(decodificaDad.getNaturaGiuridica());
	}
