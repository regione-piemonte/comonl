 ...
 */
public class PutAnagraficaDelegatoResponse extends BaseGetResponse<AnagraficaDelegato> {
	...
	public String toString() {
		...
		builder.append(this.getClass().getSimpleName() + " [PutAnagraficaDelegatoResponse=").append(anagraficaDelegato).append(", apiErrors=")
