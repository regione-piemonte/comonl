 ...
 */
public class PostTipoComunicazioneUnisommDecodificaRequest implements BaseRequest {

	
	private final DecodificaGenerica filtro;
	
	public PostTipoComunicazioneUnisommDecodificaRequest(DecodificaGenerica filtro) {
		this.filtro = filtro;
	}
	...
	public String toString() {
		...
		builder.append("PostTipoComunicazioneUnisommDecodificaRequest []");
