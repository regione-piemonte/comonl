 ...
 */
public abstract class BaseDelegatoImpresaService<Q extends BaseRequest, R extends BaseResponse> extends BaseService<Q, R> {

	/** Data Access Delegate for decodifica */
	protected final DelegatoImpresaDad delegatoImpresaDad;
	 ...
	 */
	protected BaseDelegatoImpresaService(ConfigurationHelper configurationHelper, DelegatoImpresaDad delegatoImpresaDad) {
