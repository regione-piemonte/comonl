 ...
 * Gets the Categorias
 */
public class GetCittadinanzaService extends BaseDecodificaService<GetCittadinanzaRequest, GetCittadinanzaResponse> {
	 ...
	 */
	public GetCittadinanzaService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		response.setCittadinanzas(decodificaDad.getCittadinanza());
	}
