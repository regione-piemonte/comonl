 ...
 * =========================LICENSE_END==================================
 */
package it.csi.comonl.comonlweb.ejb.util.commax.validatori.controlli.rapportolavoro.unidom;
...
public class RegolaBloccoUnidom extends ControlloAstrattoBloccante {
			...
			) throws Exception
	{
		...
		RegistrazioneEsitiControlli.registraErroreSeEsitoControlloNegativo(false, ErrorConstants.COMUNICAZIONE_LAVORO_DOMESTICO_NON_AMMESSA, null, elencoErrori, ComonlConstants.TIPO_PROVENIENZA_COMMAX, commonDad);
		//		registraErroreSeEsitoControlloNegativo( false , ErrorConstants.COMUNICAZIONE_LAVORO_DOMESTICO_NON_AMMESSA);
	}
