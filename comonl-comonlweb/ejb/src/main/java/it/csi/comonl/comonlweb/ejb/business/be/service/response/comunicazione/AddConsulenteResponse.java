 ...
 */
public class AddConsulenteResponse extends BaseGetResponse<AnagraficaDelegato> {
	...
	public String toString() {
		...
		builder.append(this.getClass().getSimpleName() + " [AddConsulenteResponse=").append(anagraficaDelegato).append(", apiErrors=")
