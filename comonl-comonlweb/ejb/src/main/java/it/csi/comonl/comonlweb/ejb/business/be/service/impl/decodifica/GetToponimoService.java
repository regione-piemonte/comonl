 ...
 * Gets the Categorias
 */
public class GetToponimoService extends BaseDecodificaService<GetToponimoRequest, GetToponimoResponse> {
	 ...
	 */
	public GetToponimoService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		response.setToponimos(decodificaDad.getToponimo());
	}
