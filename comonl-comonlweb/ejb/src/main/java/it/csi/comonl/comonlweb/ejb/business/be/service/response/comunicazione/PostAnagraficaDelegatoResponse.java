 ...
 */
public class PostAnagraficaDelegatoResponse extends BaseGetResponse<AnagraficaDelegato> {
	...
	public String toString() {
		...
		builder.append(this.getClass().getSimpleName() + " [PostAnagraficaDelegatoResponse=").append(anagraficaDelegato).append(", apiErrors=")
