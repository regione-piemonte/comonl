 ...
 * Gets the Categorias
 */
public class GetStatoEsteroService extends BaseDecodificaService<GetStatoEsteroRequest, GetStatoEsteroResponse> {
	 ...
	 */
	public GetStatoEsteroService(ConfigurationHelper configurationHelper, DecodificaDad decodificaDad) {
		super(configurationHelper, decodificaDad);
	}

	@Override
	protected void execute() {
		response.setStatoEsteros(decodificaDad.getStatoEstero());
	}
